...
@Builder
public record UserDTO(UUID id, String username, String email, String fullName, LocalDateTime lastSeen, Boolean isOnline, Set<UUID> pinnedChatIds, Set<UUID> mutedChatIds) {
